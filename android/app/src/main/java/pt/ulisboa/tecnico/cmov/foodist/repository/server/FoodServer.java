...
public class FoodServer {
    ...
    public ArrayList<FoodService> getFoodServices(String campus, String status) {
        ...
        while (foodServicesDtos.hasNext()) {
            ...
            FoodService dOption = new FoodService(dto.getName(), dto.getOpeningHoursList(), dto.getRating(), dto.getCategoriesList(), dto.getQueueTime(),dto.getLatitude(), dto.getLongitude(), dto.getBeaconName());
    ...
    public FoodService getFoodService(String campus, String status, String foodServiceName) {
       ...
       return new FoodService(dto.getName(), dto.getOpeningHoursList(), dto.getRating(), dto.getCategoriesList(), dto.getQueueTime(), dto.getLatitude(), dto.getLongitude(), dto.getBeaconName());
    }
